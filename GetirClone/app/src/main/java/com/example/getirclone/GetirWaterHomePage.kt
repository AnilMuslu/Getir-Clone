...
@Composable
fun GetirWaterHomePage(navController: NavController){
    Scaffold(
        topBar = {
            Column(
                modifier = Modifier
                ...
                Row(
                    ...
                    CenterAlignedTopAppBar(
                        title = { Text(text = "Getir Water Home Page") },
        ...
        Column(
            ...
            Image(painter = painterResource(id = R.drawable.getirwaterpromotion),
                contentDescription = "",
                modifier = Modifier
                    .fillMaxWidth()
            ...
            Row(
                ...
                GetirRectangleCardChip(onClick = {navController.navigate("profilePage")})
                GetirRectangleCardChip(onClick = {navController.navigate("profilePage")})
            }
            Row(
                modifier = Modifier
